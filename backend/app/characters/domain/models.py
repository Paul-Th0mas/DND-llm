...
class Character:
    ...
    created_at: datetime
    # Skills chosen at character creation from the class's skill_options list.
    skill_proficiencies: list[str] = dataclasses.field(default_factory=list)
    # Starting equipment items carried by the character.
    starting_equipment: list[str] = dataclasses.field(default_factory=list)
    # Spells chosen at character creation (empty for non-casters).
    spells: list[str] = dataclasses.field(default_factory=list)
    ...
    def create(
        ...
        skill_proficiencies, starting_equipment, and spells default to [] when omitted.
        """
        name = name.strip()
        if not name:
        ...
        return cls(
            ...
            skill_proficiencies=(
                skill_proficiencies if skill_proficiencies is not None else []
            ),
            starting_equipment=(
                starting_equipment if starting_equipment is not None else []
            ),
